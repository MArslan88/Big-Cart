...
class DepartmentProdAdapter(private val context: Context, private val productList: List<ProductModel>) :
    RecyclerView.Adapter<DepartmentProdAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DepartmentProdAdapter.ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.department_prod_item, parent, false))
    }

    override fun onBindViewHolder(holder: DepartmentProdAdapter.ViewHolder, position: Int) {
